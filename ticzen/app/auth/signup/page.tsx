    ...
    <div className="min-h-[calc(100vh-60px)] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-14 max-w-md">
          <p className="text-white/60 text-[14px] font-medium mb-5">Welcome to</p>
          ...
          <p className="text-gray-400 text-[13px] leading-relaxed mb-10">
            TicZen is your all-in-one platform for discovering, booking, and managing event tickets.
            Sign up to access curated experiences or effortlessly create and host your own public or private events.
          </p>
        ...
        <p className="absolute bottom-5 text-[11px] text-gray-600">
          Copyright © 2026 Design by CODEZEN
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-[360px]">
          <div className="text-center mb-7">
            <h1 className="text-[24px] font-bold text-gray-900 mb-1">Sign up</h1>
            <p className="text-[13px] text-gray-500">Sign up to enjoy the feature of TicZen</p>
          </div>
          ...
          <p className="text-center text-[13px] text-gray-500 mt-6">
            ...
            <Link href="/auth/signin" className="text-gray-900 font-bold underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
